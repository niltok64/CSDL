...
# window
patch_choice = ButtonGroup(window, options=[["Brazilian Portuguese", "BPE"], ["Simplified Chinese", "CS"], ["Dutch", "D"], ["French", "Fr"], ["German", "G"], ["Italian", "It"], ["Korean", "K"], ["Lithuanian", "L"],
["Polish", "Po"], ["Portuguese", "Por"], ["Russian", "Rus"], ["Spanish", "Sp"]], selected="BPE")
